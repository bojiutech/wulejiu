...
<!--
        var tguser = '<%=string.IsNullOrEmpty( HN.Common.CommonManager.Web.Request( "recommend", "" ) ) ? "" : HN.Common.CommonManager.Web.Request( "recommend", "" )%>';
        //init msg value
        ...
        var msgPromoter = '填入推荐人的用户名即可获赠<%=ConfigurationManager.AppSettings["moneyName"].ToString()%>(如无推荐人可不填)。'
 //-->
    </script>
    <script type="text/javascript">
    ...
    <table width="500px" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="width: 57%; text-align: left;">
                            <span class="red">*</span> <span class="note" id="unamespan">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="pwd" type="password" class="input" id="pwd" maxlength="20" onblur="chkPwd()" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="pwd2" type="password" class="input" id="pwd2" maxlength="20" onblur="chkPwd2()" />
                        </td>
                        <td>
                ...
                <table style="background-image: url(/images/gregb.png); background-repeat: no-repeat;"
                    width="480px">
                    ...
                    <tr>
                        ...
                        <td style="width: 24%; text-align: left;">
                            <input name="nickname" type="text" class="input" id="nickname" maxlength="12" onblur="chkNickName(msgNickname)" />
                        </td>
                        <td style="width: 53%; text-align: left;">
                            <span class="red">*</span> <span class="note" id="nickspan">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="mobile" id="mobile" type="text" class="input" maxlength="16" onblur="chkPhone()" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="realname" type="text" id="realname" maxlength="9" onblur="chkRealName()" />
                        </td>
                        <td>
                            <span class="red">*</span> <span class="note" id="realnamespan">请填写真实中文姓名，填写后将不可改。</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" valign="middle">
                            <input name="idcard" id="idcard" type="text" class="btn5" maxlength="18" onblur="chkidcard()" />
                        </td>
                        <td>
                            <%if (needrealname == "1")
                              { %><span class="red">*</span><%} %>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="promoter" type="text" class="input" id="promoter" maxlength="20" onblur="chkPromoter(msgPromoter)" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <textarea rows="1" id="sign" name="sign" cols="2" style="width: 300px; height: 78px;
                                border: 1px solid #0f5d9c; overflow: hidden;" onkeyup="checkSign()"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">
                        ...
                        <td>
                            <input name="validcode" id="validcode" type="text" class="inputa" maxlength="4" onblur="chkValidCode(msgValidcode)" />
                        </td>
                        <td>
                            <span class="red">*</span><img id="imgValidCode" onclick="this.src='/Public/Getcode.aspx?token='+tokenKey();"
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="checkbox" name="isaccept" id="isaccept" checked="checked" style="width: 20px" />已经阅读并同意<a
                                href="/Manage/Regg.aspx" class="red" target="_blank">服务条款</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="submit" name="btnSubmit" id="btnSubmit" runat="server" onserverclick="btnSubmit_ServerClick"
                                class="submit" value="确定提交" />
                        </td>
                        <td>
                            <input type="reset" name="Submit2" class="reset" value="" />
                        </td>
                    </tr>
                </table>
                <script type="text/javascript">
...
tip.innerText="字符数是2-16，中文是两个字符。";
	...
	function chkRealName(){
		...
		var tip=document.getElementById("realnamespan");
		//纯中文
        ...
        if(txt.value.trim().length<=0)
           {
            ...
            {
				tip.className="note_no";
				tip.innerText='真实姓名不规范，只能输入2-9位中文2222。';
				return false;
			}
