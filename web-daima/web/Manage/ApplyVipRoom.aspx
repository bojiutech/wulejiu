...
<body style="background-image: none;">
    <div id="content01" style="width: 692px; margin: 0px; padding: 0px; clear: both;
        ...
        <div id="sub_nr" style="margin-top: 10px;">
            ...
            <div id="zx">
                <div id="reg">
                    ...
                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="tab03">
                        <tr>
                            <td class="tl">
                                用户名：
                            </td>
                            ...
                            <td class="tr">
                                <input name="LoginPsw" type="password" class="btn5" id="LoginPsw" maxlength="20" title="请输入您的登录密码" />
                                <span class="red">*</span><span class="note" id="pwdspan"></span>
                            </td>
                        </tr>
                        <tr>
                            <td class="tl">
                            ...
                            <td class="tr">
                                <input name="Email" type="text" class="btn5" id="Email" maxlength="20" onblur="chkEmail()"  title="请填写您最常用请填写您最常用的电子邮箱"/>
                        ...
                        <tr>
                            ...
                            <td class="tr">
                                <input name="Mobile" type="text" class="btn5" id="Mobile" maxlength="11" onblur="chkPhone()"  title="请填写您的手机号码，前面不加0，审核通过将以短信通知"/>
                                <span class="red">*</span>
                            </td>
                            <td class="tl">
                                游戏名称：
                        ...
                        <tr>
                            ...
                            <td class="tr">
                                <input name="BeginDate" title="既开通房间日期，必须大于今天日期，开通时间统一为早上10点" type="text" class="btn5" id="BeginDate" maxlength="20" onfocus="WdatePicker({minDate:'%y-%M-#{%d+1}'})" />
                                <span class="note" id="ejpwdspan"><span class="red">*</span></span>
                            </td>
                        </tr>
                        <tr>
                            <td class="tl">
                            ...
                            <td class="tr">
                                <input name="RoomName" type="text" class="btn5" id="RoomName" maxlength="12" title="请填写房间名称，长度2到12个字符之间" />
                                <span class="note" id="ejpwd2span"><span class="red">*</span></span>
                            </td>
                            <td class="tl">
                                房间密码：
                            </td>
                            <td class="tr">
                                <input name="RoomPsw" id="RoomPsw" class="btn5" type="password" maxlength="16"  title="请填写房间密码，长度在2到16个字符之间。不需要可为空"/>
                        ...
                        <tr>
                            ...
                            <td class="tr">
                                <input name="Psw2" type="password" class="btn5" id="Psw2" maxlength="16"  title="请确认你房间的密码"/>
                            ...
                            <td class="tr">
                                <input name="DeskNum" type="text" class="btn5" id="DeskNum" value="10" maxlength="2"  title="填写该游戏房间中总共的桌子数目，最多45桌"/>
                        ...
                        <tr>
                            ...
                            <td class="tr">
                                <input name="MaxPeople" type="text" class="btn5" id="MaxPeople" value="50" maxlength="3"  title="填写该房间最多能容纳多少人进入，最多180人"/>
                        ...
                        <tr>
                            ...
                            <td class="tr">
                                <input name="BasePoint" id="BasePoint" type="text" class="btn5" value="1" maxlength="9"  title="只对金币产生倍数效果，对积分不产生倍数效果"/>
                                <span class="red">*</span> 
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="tr">
                                <input name="LessPoint" id="LessPoint" type="text" value="0" class="btn5" maxlength="9"  title="填写进入此房间所需要的最少金币数"/>
                                <span class="red"></span>
                            </td>
                            <td class="tl">
                                最高金币限制：
                            ...
                            <td class="tr">
                                <input name="MaxPoint" id="MaxPoint" type="text" class="btn5" value="0" maxlength="19" title="玩家进入此房间不能超过此金币数,为0则不限制" />
                                <span class="red"></span>
                            </td>
