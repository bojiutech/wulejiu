        ...
        <div id="sub_nr" style="margin-top: 10px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab01">
                <tr>
                    <td style="text-align: left; text-indent: 20px; padding: 0 0 3px 0;">
                        <a id="tin" href="BankTransLog.aspx?type=1">转入记录</a>&nbsp; <span><a id="tout" href="BankTransLog.aspx?type=0"
                            style="">转出记录</a></span> <span style="margin-left: 50px; vertical-align: middle;">按时间段搜索：从&nbsp;<input
                                type="text" id="txtBeginDate" size="8" class="in" style="vertical-align: middle;"
                                ...
                                &nbsp;
                                <input type="button" value=" 刷 新 " onclick="RefreshMeDelParam('[?&]{1}bd=(\\d){4}-(\\d){2}-(\\d){2}&ed=(\\d){4}-(\\d){2}-(\\d){2}');"
                                    class="but_022" />
                            </span>
                        <script>
                            var bd = $("#txtBeginDate");
            ...
            <div id="zx">
                ...
                <asp:Panel ID="PanelTransIn" runat="server">
                    ...
                    <div class="sabrosus">
                        <webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" CustomInfoHTML="当前为第%CurrentPageIndex%/%PageCount%页，每页%PageSize%条，共%RecordCount%条"
                            FirstPageText="&lt;" LastPageText="&gt;" NextPageText="下一页" PrevPageText="上一页"
                            ShowPageIndexBox="Never" UrlPaging="True" PageIndexBoxType="DropDownList" SubmitButtonText="Go"
                            TextAfterPageIndexBox="页" TextBeforePageIndexBox="转到" NumericButtonCount="5"
                            CurrentPageButtonClass="current" ShowPrevNext="False" PageSize="15">
