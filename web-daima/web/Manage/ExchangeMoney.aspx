    ...
    <body style="background-image: none;">
        <div id="content01" style="width: 703px; margin: 0px; padding: 0px; clear: both;
            ...
            <div id="r_top">
                ...
                <div id="local_B">
                    <a href="/Default.aspx">首页</a> > <a href="default.aspx">会员中心</a> ><span class="title">
                        <%=ConfigurationManager.AppSettings["moneyName"].ToString()%>兑换</span></div>
            </div>
            <!--manage-->
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword"
                            Display="Dynamic" ErrorMessage="请输入登录密码"></asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="CheckPassword"
                            ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage="登录密码不正确" SetFocusOnError="True"></asp:CustomValidator>
                    </dd>
                    <dt>代理商帐号：</dt>
                    <dd>
                        <label>
                        ...
                        <font class="red">*</font>（您要跟哪个代理商申请兑换<%=ConfigurationManager.AppSettings["moneyName"].ToString()%>）<asp:RequiredFieldValidator
                            ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAgent" Display="Dynamic"
                            ErrorMessage="请输入代理商帐号"></asp:RequiredFieldValidator>
                    </dd>
                    <dt>确认代理商帐号：</dt>
                    <dd>
                        <label>
                        ...
                        <font class="red">*</font>（请重复上面输入的代理商帐号）<asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                            runat="server" ControlToValidate="txtAgent2" Display="Dynamic" ErrorMessage="请再次输入代理商帐号"></asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtAgent"
                            ControlToValidate="txtAgent2" Display="Dynamic" ErrorMessage="两次输入的代理商帐号不一致"></asp:CompareValidator>
                        <asp:CustomValidator ID="CustomValidator2" runat="server" ClientValidationFunction="CheckAgentAccount"
                            ControlToValidate="txtAgent2" Display="Dynamic" ErrorMessage="找不到您输入的代理商，请重新核对！"
                    ...
                    <dd>
                        <label>
                            <asp:TextBox ID="txtMoney" runat="server" Style="text-align: right" CssClass="input"
                                MaxLength="10"></asp:TextBox>00
                        </label>
                        <font class="red">*</font>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMoney"
                            Display="Dynamic" ErrorMessage="请填写转帐金额"></asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtMoney"
