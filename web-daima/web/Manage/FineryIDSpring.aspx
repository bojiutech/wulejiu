                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="red">*</span> <span class="note" id="pwdspan">请输入您购买时设定的靓号密码</span>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <font class="red">*</font> <span class="note" id="unamespan">用户名长度6～12个字符，由字母、数字组成。</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <span class="red">*</span> <span class="note" id="nickspan">字母、数字、特殊符号、中文组成，长度为2-12位。</span>
                            </td>
                        </tr>
                    </table>
                </div>
                <table width="100%" border="0">
                    <tr>
                        <td style="text-align: center;">
                            <input type="submit" name="btnSubmit" id="btnSubmit" runat="server" onserverclick=" Button1_Click"
                                value="确定激活" class="but_011" />
                        </td>
                    </tr>
                </table>
                </form>
