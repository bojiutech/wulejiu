...
<!--
        ...
        var msgPromoter = ' 填入推荐人的用户名即可获赠<%=ConfigurationManager.AppSettings["moneyName"].ToString()%>。(无推荐人可不填)';
 //-->
    </script>
   ...
   <form id="frmLogin" runat="server" onsubmit="return onFormSubmit(this);">
    ...
    <div class="wrap">
        ...
        <div id="content01" style="  width:862px;  margin:0px auto; ">
            ...
            <div id="sub_nr">
             <div class="cz" style=" clear:both; width:100%; margin-left:50px; overflow:hidden;">                <p>
                    <strong class="text04">帐号信息</strong></p>
                <table width="90%" summary="" border="0" >
                    <caption>
                    </caption>
                    <colgroup>
