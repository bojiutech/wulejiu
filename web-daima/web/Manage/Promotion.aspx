                ...
                <div class="cz">
                    <table id="dltgAddress" runat="server" visible="false" width="100%" border="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td width="71%" valign="middle">
                                <a href="/Manage/PromotionCheckout.aspx" class="under_line">点击转到我的推广收入页面</a>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="cz">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab07">
                        ...
                        <tr>
                            ...
                            <td width="71%" valign="middle">
                                <asp:TextBox ID="txtTrueName" runat="server" CssClass="pro_input"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td valign="middle">
                                <asp:TextBox ID="txtAddress" runat="server" CssClass="pro_input" MaxLength="50"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
