        ...
        <div id="sub_nr" style="margin-top: 10px;">
            <div class="cz">
                <asp:Repeater ID="rpList" runat="server">
                    <ItemTemplate>
                        <table width="98%" border="0" cellspacing="0" cellpadding="0" class="tableMessage">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td height="23" class="textgray">
                                    <%# GetState(Eval("ispass"))%>
                                </td>
                            </tr>
                            <tr>
                                <th>
            ...
            <div class="sabrosus">
                <webdiyer:AspNetPager ID="anpPageIndex" runat="server" AlwaysShow="True" CustomInfoHTML="当前为第%CurrentPageIndex%/%PageCount%页，每页%PageSize%条，共%RecordCount%条"
                    ...
                    CurrentPageButtonClass="current" ShowPrevNext="False" PageSize="3">
