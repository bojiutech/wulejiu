<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardPay.aspx.cs" Inherits="HN.Web.Manage.Pay.Zhifu.CardPay" %>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList runat="server" ID="dr_type">
                                    <asp:ListItem Value="YDSZX" Text="移动神州行"></asp:ListItem>
                                    <asp:ListItem Value="LTYKT" Text="联通一卡充"></asp:ListItem>
                                    <asp:ListItem Value="DXGK" Text="电信国卡"></asp:ListItem>
                                    <asp:ListItem Value="JWYKT" Text="骏网一卡通"></asp:ListItem>
                                    <asp:ListItem Value="SDYKT" Text="盛大一卡通"></asp:ListItem>
                                    <asp:ListItem Value="QBCZK" Text="QQ币充值卡"></asp:ListItem>
                                    <asp:ListItem Value="WMYKT" Text="完美一卡通"></asp:ListItem>
                                    <asp:ListItem Value="ZTYKT" Text="征途一卡通"></asp:ListItem>
                                    <asp:ListItem Value="WYYKT" Text="网易一卡通"></asp:ListItem>
                                    <asp:ListItem Value="SHYKT" Text="搜狐一卡通"></asp:ListItem>
                                    <asp:ListItem Value="JYYKT" Text="九游一卡通"></asp:ListItem>
                                    <asp:ListItem Value="THYKT" Text="天宏一卡通"></asp:ListItem>
                                    <asp:ListItem Value="GYYKT" Text="光宇一卡通"></asp:ListItem>
                                    <asp:ListItem Value="TXYKT" Text="天下一卡通"></asp:ListItem>
                                    <asp:ListItem Value="ZYYKT" Text="纵游一卡通"></asp:ListItem>
                                    <asp:ListItem Value="TXYKTZX" Text="天下一卡通专项"></asp:ListItem>
                                    <asp:ListItem Value="SFYKT" Text="盛付通一卡通"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
