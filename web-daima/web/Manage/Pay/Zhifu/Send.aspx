<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Send.aspx.cs" enableEventValidation="false" enableViewStateMac="false"
    Inherits="HN.Web.Manage.Pay.Zhifu.Send" %>
...
<body>
    <form action="https://pay.dinpay.com/gateway?input_charset=UTF-8" id="dinpayForm"
    name="dinpayForm" method="POST" runat="server">
