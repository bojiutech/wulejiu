						...
						<asp:Repeater runat="server" ID="rptDataList">
							<ItemTemplate>
								<dl>
									...
									+"<img src='/Public/Thumbs.aspx?path=" + Server.UrlEncode( Eval( HN.Entities.VUsersAlbum._.PicPath.Name ).ToString() ) + "&width=94&height=94' alt='" + Eval( HN.Entities.VUsersAlbum._.PicName.Name ) + "' title='" + Eval( HN.Entities.VUsersAlbum._.PicName.Name ) + "' onerror='this.src=\"/images/none.jpg\"' /></a>"%>
									</dt>
								<%--	<dd>
										<%#"<a href='"+Eval( HN.Entities.VUsersAlbum._.PicPath.Name).ToString()+"' title='查看原图' target='_blank'>" + Eval( HN.Entities.VUsersAlbum._.PicName.Name ).ToString() + "</a>"%>
									</dd>	--%>
									<dd>
										<%# "<a href='/UserInfo/Default.aspx?params=" + Server.UrlEncode(Eval(HN.Entities.VUsersAlbum._.UserID.Name).ToString()) + "' title=''>" + Eval(HN.Entities.VUsersAlbum._.NickName.Name).ToString() + "</a>"%>
									</dd>
								<%--	<dd>
										相册：<%# "<a href='/UserInfo/PhotoList.aspx?params="+Eval(HN.Entities.VUsersAlbum._.ColumnID.Name).ToString()+"' title='查看TA的相册' target='_blank'>"+Eval(HN.Entities.VUsersAlbum._.AlbumName.Name).ToString()+"</a>" %></dd>--%>
								</dl>
							</ItemTemplate>
						</asp:Repeater>
