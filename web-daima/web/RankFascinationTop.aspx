<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RankFascinationTop.aspx.cs"
    Inherits="Bzw.Web.RankFascinationTop" %>
            ...
            <div class="wrap">
                <div class="totalContent">
                    <div class="totalHd png" style="background-image: none; background-color: #bedff6;
                        ...
                        <div class="text">
                            <a href="/Leaderboard.aspx">在线时长排行 </a>&nbsp;| &nbsp; <a href="/MatchListTop.aspx">淘汰赛排行</a>
                            &nbsp;| &nbsp; <a href="/RankGameTimeTop.aspx">游戏时间排行 </a>&nbsp;| &nbsp; <a style="color: #fff;"
                                href="/RankFascinationTop.aspx">魅力值排行</a>
                        </div>
                    </div>
                    <div class="totalBd">
