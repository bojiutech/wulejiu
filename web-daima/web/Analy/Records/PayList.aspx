<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PayList.aspx.cs" Inherits="DataAnaly.Analy.Records.PayList" %>
			...
			<div class="datalist">
				...
				<div class="search" style="width: auto;">
					&nbsp;&nbsp;<input type="text" name="txtUserName" id="txtUserName" />&nbsp;&nbsp;<input
						type="text" name="txtUserID" id="txtUserID" />&nbsp;&nbsp;日期：<input type="text" name="txtBeginDate" id="txtBeginDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtEndDate\')}'});" />&nbsp;&nbsp;
