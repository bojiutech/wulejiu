<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UserInfoList.aspx.cs" Inherits="DataAnaly.Analy.Records.UserInfoList" %>
						...
						<asp:Repeater runat="server" ID="rptDataList">
							<ItemTemplate>
								<tr>
									...
									<td align="center">
										<a href="/Analy/Records/GameRecord.aspx?un=<%# Eval( "UserName" ).ToString()%>&reurl=<%=Server.UrlEncode( Request.Url.AbsoluteUri ) %>"
