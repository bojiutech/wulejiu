<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AgencyDateReport.aspx.cs"
	Inherits="DataAnaly.Analy.Report.AgencyDateReport" %>
			...
			<div class="datalist">
				...
				<table id="tbContent">
					...
					<tbody id="tbdDataList">
						<asp:Repeater runat="server" ID="rptDataList">
							<ItemTemplate>
								<tr style="cursor: auto;">
									...
									<td align="center">
										<a href="/Analy/Records/PayList.aspx?bd=<%# Eval( "ReportDate","{0:yyyy-MM-dd}" )%>&ed=<%# Eval( "ReportDate","{0:yyyy-MM-dd}" )%>&ag=<%#Eval( "AgencyName" ).ToString()%>&reurl=<%=Server.UrlEncode( Request.Url.AbsoluteUri ) %>"
											title="点击可查看当日<%#Eval( "AgencyName" ).ToString()%>代理商直属玩家注册记录" class="hrefColor">
						...
						<asp:Literal runat="server" ID="ltNonData" Text="<tr><td colspan='19'>还没有任何数据。</td></tr>"></asp:Literal></tbody></table>
				<div class="pager">
