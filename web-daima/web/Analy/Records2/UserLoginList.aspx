<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginList.aspx.cs"
    Inherits="Bzw.Web.Analy.Records2.UserLoginList" %>
                    ...
                    <asp:Repeater runat="server" ID="rptDataList">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="/Analy/Records2/UserLoginDetail.aspx?bd=<%=HN.Common.CommonManager.Web.RequestUrlDecode( "bd", "" ) %>&ed=<%=HN.Common.CommonManager.Web.RequestUrlDecode( "ed", "" )%>&un=<%# Eval( "UserName" ).ToString()%>&reurl=<%=Server.UrlEncode( Request.Url.AbsoluteUri ) %>"
                                ...
                                <td align="center">
                                    <a href="/Analy/Records2/GameRecord.aspx?bd=<%=HN.Common.CommonManager.Web.RequestUrlDecode( "bd", "" ) %>&ed=<%=HN.Common.CommonManager.Web.RequestUrlDecode( "ed", "" )%>&un=<%# Eval( "UserName" ).ToString()%>&reurl=<%=Server.UrlEncode( Request.Url.AbsoluteUri ) %>"
                                        title="点击可查看<%# Eval( "UserName" ).ToString()%>用户该段时间内游戏记录信息" class="hrefColor">
                                        <%# Eval( "GameCount" )%>
                                    </a>
                                </td>
                                <td align="center">
                                    <a href="/Analy/Records2/PayList.aspx?bd=<%=HN.Common.CommonManager.Web.RequestUrlDecode( "bd", "" ) %>&ed=<%=HN.Common.CommonManager.Web.RequestUrlDecode( "ed", "" )%>&un=<%# Eval( "UserName" ).ToString()%>&reurl=<%=Server.UrlEncode( Request.Url.AbsoluteUri ) %>"
