<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameNew.aspx.cs" Inherits="Bzw.Web.GameNew" %>
            ...
            <div class="wrap">
                <div class="totalContent">
                    <div class="totalHd png" style="background-image: none; background-color: #bedff6;
                        ...
                        <div class="text">
                            <p style=" color:black;">
                                <%=GameName %>&nbsp;&nbsp;<img title=' <%=GameName %>' src="/Images/cont_bullet02.jpg"
                                    alt="" /><a href="<%=GameDownAddress %>">点击下载</a>
                            </p>
                        </div>
                    </div>
                    <div class="totalBd">
