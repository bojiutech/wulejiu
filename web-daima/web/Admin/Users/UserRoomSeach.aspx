<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Users_UserList_Seach_UserRoomSeach"
    CodeBehind="UserRoomSeach.aspx.cs" %>
...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            <td class="title_03">
                <strong>查询[&nbsp;<font color="red"><%=usernames %></font>&nbsp;]的房间记录</strong>
            </td>
        </tr>
    ...
    （结果中显示的最多记录数，0为显示所有的）</td>
        ...
        <tr>
            ...
            <td align="left">
                ...
                降序（显示结果的排列顺序项，选定降序即按排序项的降序方式排列，不选即表示升序。）
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td align="left">
                <input id="Button1" type="button" runat="server" onserverclick="SearchPage" value=" 查 询 "
                    class="put" />
            </td>
        </tr>
    </table>
