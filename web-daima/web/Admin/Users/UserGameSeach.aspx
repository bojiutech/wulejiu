<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Users_UserList_Seach_UserGameSeach"
    CodeBehind="UserGameSeach.aspx.cs" %>
...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            <td class="title_03">
                <strong>查询[&nbsp;<font color="red"><%=usernames %></font>&nbsp;]的游戏记录</strong>
            </td>
        </tr>
        <asp:Panel ID="YesGameSeach" runat="server" Width="100%" Visible="true">
            <tr>
                <td>
                    <a href="UserGameSeach.aspx?id=<%=seachids %>">1、查询游戏记录</a> <a href="UserMoneySeach.aspx?id=<%=seachids%>">
                        2、查询游戏房间里的存取记录</a> <a href="UserRoomSeach.aspx?id=<%=seachids%>">3、查询房间记录</a>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            ...
            <td align="left">
                <strong>尽量的缩小搜索的范围，把一次大的搜索分多次查询；当记录很多时，系统会很慢。</strong>
            </td>
        </tr>
        <tr>
            <td width="14%" align="right" valign="baseline">
                <span class="STYLE1">*</span> 房间类型：
            </td>
        ...
        <tr>
            ...
            <td align="left" style="height: 31px">
                ...
                <input id="Button2" type="button" runat="server" onserverclick="SearchPage" value=" 查 询 "
                    class="put" />
            </td>
        </tr>
    </table>
