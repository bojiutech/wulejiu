<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Users_UsersMoneyChangeLogNew" Codebehind="UsersMoneyChangeLogNew.aspx.cs" %>
			...
			<tr>
				<td align="left" bgcolor="F2F8FF" class="title_05">
					...
					<select id="stChangeType" name="stChangeType">
                        ...
                        <option value="4">购买道具</option>
                        <option value="6">购买VIP</option>
                      <%--  <option value="8">魅力值兑换金币</option>--%>
                        <option value="9">购买靓号</option>
                        <option value="11">靓号转移数据</option>
                        <option value="12">点卡充值</option>
                        <option value="13">代理充金币</option>
                        <option value="14">代理提取金币</option>
                        <option value="21">比赛报名</option>
                        <option value="22">比赛报名退赛</option>
                        <option value="26">注册赠送</option>
                      <%--  <option value="30">租赁房间获得抽水</option>--%>
                        <option value="31">每局时长送金币</option>
                        <option value="50">连续签到奖励</option>
                        <option value="51">手游在线送金币</option>
					</select>
