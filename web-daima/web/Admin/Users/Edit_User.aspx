		...
		<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7" bgcolor="F2F8FF" class="admin_table">
			<tr>
				<td colspan="2" class="title_03">
					<strong>修改用户[&nbsp;<asp:Literal runat="server" ID="ltUserName"></asp:Literal>&nbsp;]资料</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='../SConfig/UserPropEdit.aspx?para=<%=UserID%>&params=<%=userName %>'>查看该用户的道具数量</a>
       ...
       { %>   <a href="#" onclick="openRoomRuleDiv('UserWalletMoney.aspx?UserID=<%=UserID %>',550,320);">点此查看</a>	<%} %>
            ...
            <tr>
				<td align="right">
					钻石：</td>
				<td align="left">
					<asp:TextBox ID="TextJewels" runat="server" Class="put" MaxLength="18"></asp:TextBox></td>
			</tr>
			<tr>
			...
			<tr runat="server" id="trIsTrader" style="display:none;">
				<td align="right">
					是否是超级玩家：</td>
				<td align="left">
		...
		<%--	<tr>
			...
			<tr>
				<td align="right">
					机器人逃跑率：</td>
				<td align="left">
			<asp:TextBox runat="server" ID="txtCut" MaxLength="2" ></asp:TextBox>% 
			<br />
			注：如果机器人的逃跑率是0，则不能修改逃跑率。逃跑率：逃跑的次数/总局数。	修改的是机器人所有游戏的逃跑率。建议机器人玩超过一定局数后再配置。
				</td>
			</tr>
			<%} %>
			<tr>
