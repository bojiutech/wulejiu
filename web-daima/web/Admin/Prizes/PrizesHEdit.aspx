    ...
    <form id="form1" runat="server">
        <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
            ...
            <tr>
              ...
              <% if (PIsCash!=null&&"true".Equals(PIsCash.ToLower()))
                 {
                     %>
                       <input name="IsCash" type="radio" value="1" class="put" checked="checked" />是
                    <input name="IsCash" type="radio" value="0" class="put" />否
                
                
                    
                 <%   }else{%>
                   <input name="IsCash" type="radio" value="1" class="put"  />是
                    <input name="IsCash" type="radio" value="0" class="put" checked="checked"/>否
