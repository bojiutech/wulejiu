<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrizeClassAdd.aspx.cs"
    Inherits="Bzw.Admin.Admin.Prizes.PrizeClassAdd" %>
...
<body>
    ...
    <table border="1" align="left" width="60%" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            ...
            <td>
                <input type="text" id="txtClass" name="txtClass" maxlength="20" class="put" />
            </td>
        </tr>
        <br />
        <tr>
            ...
            <td>
                <input type="text" id="txtDes" name="txtDes" class="put" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td >
                ...
                <asp:Label ID="lbimg" runat="server" Text=""></asp:Label><span style="font-size: 18px;
