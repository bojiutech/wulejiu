...
<table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="right">  <a href="javascript:reloadcode()"  >
        <img src='/Public/Getcode.aspx?<%# new Random().NextDouble() %>' style="width:45px; height:20px;" id="safecode" style="border:0" title="看不清，换一张"  alt="看不清，换一张"/>
            ...
            <td width="67" background="images/login_09.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <asp:ImageButton ID="ImageButton1" ImageUrl="images/dl.gif"  OnClientClick="return check();" 
