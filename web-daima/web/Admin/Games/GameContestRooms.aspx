<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameContestRooms.aspx.cs"
    Inherits="Admin_Games_GameContestRooms" %>
    ...
    <asp:Repeater ID="rptDataList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    	<%#BindName(Eval("ContestID").ToString())%>
                </td>
                <td>
                    <%#Eval("EntryFee") %>
                </td>
                ...
                <td>
                    <a href='GameContestRank.aspx?id=<%#Eval("ContestID")%>'>排行榜</a> <a href='GameContestRoomsWrite.aspx?id=<%# Eval("ContestID") %>'>
                        修改</a>&nbsp;&nbsp;<a href='GameContestRooms.aspx?action=del&params=<%# Eval("ContestID") %>'
                            onclick="javascript:return confirm('你确定要删除该房间吗？');">删除</a> <a href="/Manage/MatchApply2.aspx?id=<%#Eval("ContestID") %>"
                                target="_blank">预览</a>
                </td>
            </tr>
        </ItemTemplate>
            ...
            <td align="left">
                <div id="page_link" class="page_link">
                    <webdiyer:AspNetPager runat="server" ID="anpPageIndex" CustomInfoHTML="%CurrentPageIndex%/%PageCount%，每页%PageSize%条"
                        ...
                        UrlPaging="True" AlwaysShow="True" PageSize="30">
