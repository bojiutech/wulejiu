...
<body>
	...
	<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="A4B6D7"
		...
		<tr>
			...
			<td align="left">
				<input type="radio" name="bEnableBuy" value="0" checked="checked" class="put" />
				不可购买
				<input type="radio" name="bEnableBuy" value="1" class="put" />
				可购买
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<input name="DeskCount" type="text" id="DeskCount" class="put" size="10"  value="10"
					maxlength="2" />填写该游戏房间中总共的桌子数目,45
			</td>
		</tr>
		<tr>
			<td align="right">
		...
		<tr style="display:none">
			...
			<td align="left">
				<input name="BasePoint" type="text" id="BasePoint" class="put" value="1" size="10"
					maxlength="9" />只对金币产生倍数效果，对积分不产生倍数效果
			</td>
		</tr>
		<tr>
			<td align="right">
		...
		<tr>
			...
			<td align="left">
				<input name="ServiceName" type="text" id="ServiceName" value="hngame" class="put"
