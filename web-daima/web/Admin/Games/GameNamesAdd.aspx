        ...
        $().ready(function () {
            ...
            $("#NameID").change(function () {
                ...
                if (NameID != null && NameID.length > 0) {
                    $("#ComProcess").val($("#NameID").val() + ".exe");
                    $("#DLLFileName").val($("#NameID").val() + ".DLL");
                } else {
                    $("#ComProcess").val('');
                    $("#DLLFileName").val('');
                }
        ...
        <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
            ...
            <tr>
                <td align="right">
                    游戏ID号：</td>
                <td align="left">
                    <input type="text" name="NameID" id="NameID" value='' class="put" maxlength="9" /><font color="red">（需与游戏提供商咨询）</font>
                </td>
            </tr>
         <tr>
                <td align="right">
                    游戏版本：</td>
                <td align="left">
                    <input type="text" name="txtVersion" value='1.0' id="txtVersion" runat="server" class="put" maxlength="9" /><font color="red"></font>
                </td>
            </tr>    
            <tr>
                <td align="right">
