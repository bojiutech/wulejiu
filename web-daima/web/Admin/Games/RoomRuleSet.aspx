<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Games_RoomRuleSet"
    CodeBehind="RoomRuleSet.aspx.cs" %>
...
<body>
    <div align="center">
        <div align="left">
            ...
            <span>
                <input type="checkbox" name="checkbox" value="4" <%=getRoomRule(4) %> />允许旁观</span><br />
            <br />
            <span>
            ...
            <span>
                <input type="checkbox" name="checkbox" value="32" <%=getRoomRule(32) %> />限制坐位</span>
            <br />
            <br />
            <span>
            ...
            <%-- <span>
					<input type="checkbox" name="checkbox" value="4096" <%=getRoomRule(4096) %> />比赛报名</span>--%><br />
            <br />
            <span>
            ...
            <span>
                <input type="checkbox" name="checkbox" value="8192" <%=getRoomRule(8192) %> />练习房</span>
            <span>
                <input type="checkbox" name="checkbox" value="1573504" />比赛房(人满开赛)</span><br />
            <br />
            <span>
                <input type="checkbox" name="checkbox" value="8388608" <%=getRoomRule(1310720) %> />比赛房(定时开赛)</span>
            <br />
            <br />
            <span>
                <input type="checkbox" name="checkbox" value="262144" <%=getRoomRule(262144) %> />排队机</span>
            <span>
                <input type="checkbox" name="checkbox" value="65536" <%=getRoomRule(65536) %> />防作弊</span>
            <span>
                <input type="checkbox" name="checkbox" value="2097152" <%=getRoomRule(2097152) %> />U3D游戏</span>
            <span>
                <input type="checkbox" name="checkbox" value="16777216" <%=getRoomRule(16777216) %> />Cocos2d</span>
