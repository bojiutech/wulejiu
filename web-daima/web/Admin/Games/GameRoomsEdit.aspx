...
<script language="javascript" type="text/javascript">
    ...
    function openRoomRuleDiv(page, width, height) {
        page += "?RoomRule="+$("#RoomRule").val()+"&rd="+Math.random();
...
-->
		...
		<tr>
			...
			<td align="left">
				<input name="bEnablebuy" type="radio" value="0" <%= (SbEnableBuy.ToString().ToLower()=="0" ? "checked" : "") %>
					class="put" />
				不可购买
				<input type="radio" name="bEnablebuy" value="1" <%= (SbEnableBuy.ToString().ToLower()=="1" ? "checked" : "") %>
					class="put" />
				可购买
			</td>
		</tr>
		...
		<tr>
			...
			<td align="left">
				<input type="text" size="10" name="RoomRule" id="RoomRule" value="<%=SRoomRule %>"
					...
					onclick="openRoomRuleDiv('RoomRuleSet.aspx',350,320)" class="put"/>
			</td>
		</tr>
		<tr>
			<td align="right">
