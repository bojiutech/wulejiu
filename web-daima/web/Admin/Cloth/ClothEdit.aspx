...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            ...
            <td width="83%" align="left">
                <input type="text" name="WeekPrice" id="WeekPrice" value="<%=WeekPrice %>" maxlength="13" class="put" /><%=UiCommon.StringConfig.MoneyName %>
            </td>
        </tr>
        <tr>
            <td  width="17%" align="right">30天价格：</td>
             <td width="83%" align="left"><input type="text" name="MonthPrice" id="MonthPrice" value="<%=MonthPrice %>" maxlength="13" class="put" /><%=UiCommon.StringConfig.MoneyName %></td>
        </tr>
        <tr>
            <td width="17%" align="right">
