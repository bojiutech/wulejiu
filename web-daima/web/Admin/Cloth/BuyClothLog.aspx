<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyClothLog.aspx.cs" Inherits="Admin_Cloth_BuyClothLog" %>
...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#A4B6D7"
        ...
        <tr>
            <td align="center" bgcolor="F2F8FF" class="title_03">
                <strong>购买服装日志</strong>
            </td>
        </tr>
        <tr>
            <td align="left" bgcolor="F2F8FF" class="title_05">
                按购买时间段，从：<input type="text" id="txtBeginDate" name="txtBeginDate" class="put" style="width: 75px;"
                    onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'txtEndDate\')}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />&nbsp;到&nbsp;<input
                        type="text" id="txtEndDate" name="txtEndDate" style="width: 75px;" class="put"
                        onfocus="WdatePicker({minDate:'#F{$dp.$D(\'txtBeginDate\')}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <th>序号</th>
            ...
            <th>
                7天消耗<%=UiCommon.StringConfig.MoneyName %>
            </th>
            <th>
               30天消耗<%=UiCommon.StringConfig.MoneyName %>
            </th>
            <th>
                到期时间
            </th>
        ...
        <asp:Repeater ID="rptDataList" runat="server">
            <ItemTemplate>
                ...
                <td><%=listids%></td>
                    ...
                    <td align="center" style="width: 10%;">
                        <%# Eval("IsUsing").ToString().ToLower()=="true"?"使用中":"已弃用"%>
                    </td>
                    <td style="width: 15%;">
                        <%# Eval("AddTime")%>
                    </td>
