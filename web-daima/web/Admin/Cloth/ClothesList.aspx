    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            <td class="title_03" colspan="11">
                <strong><font color="red">服装列表</font></strong>
            </td>
        </tr>
            ...
            <ItemTemplate>
                ...
                <td>
                    <img src='/Image/Users/<%#Eval("Sex").ToString() == "True" ? "b_" +( Convert.ToInt32(Eval("LogID").ToString())+1) + ".png" : "g_" + (Convert.ToInt32(Eval("LogID").ToString())+1) + ".png"%>'
                        alt="" width="55" height="55" onerror="this.src='/Images/NoPicture/no_pic.gif';this.onerror='';" />
                </td>
                <td>
                    <%=UiCommon.StringConfig.MoneyName %>:<%# Eval("WeekPrice")%>
                </td>
                <td>
                    <%=UiCommon.StringConfig.MoneyName %>:<%# Eval("MonthPrice")%>
                </td>
                <td>
                    <%# Eval("SendLotteries") %>
                </td>
                <td>
                    <a href='ClothEdit.aspx?id=<%# Eval("ID") %>'>修改价格</a>
                </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
