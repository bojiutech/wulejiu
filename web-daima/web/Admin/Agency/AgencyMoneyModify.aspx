			...
			<table cellpadding="5" cellspacing="0" border="0" style="text-align: center; width: 100%; font-size: 12px; border-collapse: collapse">
				<tr>
					<th colspan="2">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;帐号当前钻石：<%= UiCommon.StringConfig.MoneyChu100(AgencyInfo["Jewels"])%>。
					</th>
				</tr>
				<tr>
					...
					<td style="text-align: left; height: 24px;">
						<asp:TextBox ID="tbxAccount" MaxLength="19" Width="165" runat="server" Style="ime-mode: disabled;" onkeyup="if(isNaN(value))execCommand('undo')" />
                ...
                <tr>
					...
					<td style="text-align: left; height: 24px;">
						<asp:DropDownList ID="DropDownList1" runat="server">
                          <asp:ListItem Text="金币" Value="1">
                          </asp:ListItem>
                          <asp:ListItem Text="钻石" Value="2">
                          </asp:ListItem>
                        </asp:DropDownList>
					</td>
				</tr>
				...
				<asp:Repeater runat="server" ID="rptDataList">
					<ItemTemplate>
						<tr>
                            ...
                            <td align="center">
								<%#Convert.ToInt32( Eval("stype"))==1?"金币":"钻石"%>
							</td>
							<td align="center">
