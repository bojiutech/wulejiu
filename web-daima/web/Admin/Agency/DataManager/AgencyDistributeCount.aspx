<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_DataManager_AgencyDistributeCount" Codebehind="AgencyDistributeCount.aspx.cs" %>
...
<form id="form1" runat="server">
   <div style="text-align:center; font-size:13px;margin:0 auto; width:98%; border:1px solid;">    
        ...
        <table border="1px;" style="width:100%;border-collapse:collapse; padding:0; margin:0;"  align="center">
            <tr>
                <td colspan="4">
                    代理商帐号:<input type="text" id="tusername" name="tusername" />
                    &nbsp;&nbsp;&nbsp;上级代理商:<input type="text" id="tagencyname" name="tagencyname" />
            ...
            <tr>
                ...
                <asp:Repeater ID="rptDataList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr>
                                <td><%# WebPager1.PageSize * (WebPager1.CurrentPageIndex - 1) + (Container.ItemIndex + 1)%></td>
                                <td><%# Eval("AgencyName")%></td>
                                <td><%# UiCommon.StringConfig.MoneyChu100(Eval("SpareMoney"))%></td>     
