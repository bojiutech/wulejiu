<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_MyEarningMoney" Codebehind="MyEarningMoney.aspx.cs" %>
		...
		<table border="1px;" cellpadding="3" style="width: 100%; border-collapse: collapse;">
			...
			<tr>
				<td>
                    ...
                    &nbsp;&nbsp;<asp:Button ID="btnSearch" runat="server" CssClass="put" Text=" 查 询 " OnClick="btnSearch_Click" OnClientClick="return OnSearch()" />
