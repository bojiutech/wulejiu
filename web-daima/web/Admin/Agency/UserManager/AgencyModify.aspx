<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_AgencyModify" Codebehind="AgencyModify.aspx.cs" %>
				...
				<td class="title_03" colspan="15" align="right">
					...
					<script>
							...
							function OnSearch()
							{
								...
								alert("请先输入您要搜索的代理或管理员玩家帐号，或选择要查看的时段。");
							}
					</script>
			...
			<asp:Repeater ID="rptDataList" runat="server">
				<ItemTemplate>
					<tr>
						...
						<td align="center">
							<%# Eval( "InputDate","{0:yyyy-MM-dd HH:mm}" )%>
						</td>
						<td align="center">
							<%# "<a href='AgencyModify.aspx?params=" + Eval( "ID" ).ToString() + "&url=" + Server.UrlEncode( Request.Url.AbsoluteUri ) + "' onclick='return confirm(\"您确定要删除这条记录吗？\\r\\n注意：此操作不可恢复！\");'>删除</a>"%>
						</td>
					</tr>
				</ItemTemplate>
			</asp:Repeater>
