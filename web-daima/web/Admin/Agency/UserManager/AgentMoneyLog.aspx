<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_AgentMoneyLog" Codebehind="AgentMoneyLog.aspx.cs" %>
		...
		<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7" bgcolor="F2F8FF" class="admin_table">
			...
			<tr>
				<td class="title_03" colspan="3">
					<strong style="color: Red;">代理商充\提金币记录</strong></td>
				<td class="title_03" colspan="15" align="right">
					<select id="selIdentity" name="selIdentity" onchange="OnIdenSelected(this);">
						<option value="none">=按被操作人身份=</option>
					...
					<script>
							...
							DropSetByValue("selIdentity",GetRequest("iden","none"));
							...
							//按身份搜索事件
							function OnIdenSelected(obj)
							{
								var value = obj.options[obj.selectedIndex].value;
								if(value == "none")
								{
									RefreshMeDelParam("(&)?iden=(\\d+)");
								}
								else
								{
									LocationToMeParam("iden=" + value);
								}
							}
			...
			<asp:Repeater ID="rptDataList" runat="server">
				<ItemTemplate>
					<tr>
						...
						<td align="center">
							<%# (bool)Eval( "ReceiverType" ) ? "<span style='color:rgb(97,86,146)'>代理<span>" : "玩家"%>
						</td>
						<td align="center">
						...
						<td align="center">
							<%# "<a href='AgentMoneyLog.aspx?params=" + Eval( "TransferID" ).ToString() + "&url=" + Server.UrlEncode( Request.Url.AbsoluteUri ) + "' onclick='return confirm(\"您确定要删除这条记录吗？\\r\\n注意：此操作不可恢复！\");'>删除</a>"%>
						</td>
					</tr>
				</ItemTemplate>
			</asp:Repeater>
