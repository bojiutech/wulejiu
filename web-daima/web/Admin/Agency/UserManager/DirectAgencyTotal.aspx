<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_DirectAgencyTotal" Codebehind="DirectAgencyTotal.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
		<table border="1px;" cellpadding="3" style="width: 100%; border-collapse: collapse;">
		    ...
		    查看代理商<%=Utility.Common.GetStringOfUrl("n")%>的直属代理在抽水中的收益
