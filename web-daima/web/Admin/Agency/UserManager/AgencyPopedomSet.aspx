<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_AgencyPopedomSet" Codebehind="AgencyPopedomSet.aspx.cs" %>
						...
						<table width="563" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse; border-color: powderblue;">
							...
							<tr>
								<td colspan="4" align="left" style="height: 30px; font-size: 14px;">
									...
									<asp:CheckBox runat="server" ID="cbxIsPickUpCashToAgency" Text="允许提取直属代理的金币" style="margin-right:15px;" />
									<asp:CheckBox runat="server" ID="cbxIsGiveToAgency" Text="允许对直属代理充金币" /><br />
									<asp:CheckBox runat="server" ID="cbxIsPickUpCashToPlayer" Text="允许提取直属玩家的金币" style="margin-right:25px;" />
									<asp:CheckBox runat="server" ID="cbxIsGiveToPlayer" Text="允许对直属玩家充金币" />
								</td>
							</tr>
							<tr>
								<td align="center" colspan="4">
									<asp:Button ID="btnMondify" runat="server" CssClass="put" Text=" 修 改 " OnClick="btnMondify_Click" />&nbsp;
