<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_ChildAgencyDetail" Codebehind="ChildAgencyDetail.aspx.cs" %>
...
<body style="font-size: 12px; margin-top: 20px;">
	<form id="form1" runat="server">
		...
		<div style="font-size: 1px; text-align: center; margin-top: 20px;">
			<input type="button" value="返回" class="put" onclick="history.back();" />
		</div>
	</form>
</body>
</html>
