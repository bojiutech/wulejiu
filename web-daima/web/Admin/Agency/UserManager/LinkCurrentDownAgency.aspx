<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_LinkCurrentDownAgency" Codebehind="LinkCurrentDownAgency.aspx.cs" %>
			...
			<table border="1" cellpadding="3" style="width: 98%; border-collapse: collapse;">
				...
				<tr>
					<td align="left">
						...
						<input type="button" value="搜索" class="put" onclick="OnSearch();" />&nbsp;
						<input type="button" value="刷新" class="put" onclick="RefreshMeDelParam('[&]?key=(\\S)+');" />
