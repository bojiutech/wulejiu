<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_AgencyView" Codebehind="AgencyView.aspx.cs" %>
                    ...
                    <%# ( ( Container.ItemIndex + 1 ) % 2 ) == 0 ? "  <tr align='center' bgcolor='#F7F8F8' height='25px' onmouseout=\"this.style.backgroundColor='#F7F8F8'\" onmouseover=\"this.style.backgroundColor='#E1E1E1'\" >" : "  <tr align='center' bgcolor='#ffffff' height='25px' onmouseout=\"this.style.backgroundColor='#ffffff'\" onmouseover=\"this.style.backgroundColor='#E1E1E1'\" >"%>
                        ...
                        <td>
                           ...
                           <br /><a href="<%# "AgencyDetailInfo.aspx?agencyid="+Eval("AgencyID")+"&url="+ Utility.Common.CurrentPageUrl %>">修改资料</a>
						    ...
						    <br /><a href="<%# "AgencyView.aspx?action=balance&id="+Eval("AgencyID")+"&url="+ Utility.Common.CurrentPageUrl %> " onclick='return confirm("确定要进行结算吗？");' title='点击进行结算'>抽水结算</a>
						    ...
						    <!--a href="<%# "/Admin/Agency/UserManager/AgencyWasteBook.aspx?uid="+Eval("AgencyID")+"&plist=1&url="+ Utility.Common.CurrentPageUrl %>">收支流水账</a-->
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
