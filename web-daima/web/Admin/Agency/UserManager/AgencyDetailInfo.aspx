<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Agency_UserManager_AgencyDetailInfo" Codebehind="AgencyDetailInfo.aspx.cs" %>
	...
	<form id="form1" runat="server">
		<div style="text-align: center; font-size: 13px;">
			<table border="1px;" style="width: 98%; border-collapse: collapse;">
                ...
                <tr>            
                    <td style="width: 200px;text-align:right;"> 抽水比例:</td>
                    <td style="text-align:left">&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="tbxSpareValue" runat="server"  Text="0" MaxLength="3" Width="30"/>%<span style="color:red">*</span> 允许的变动范围[<%=ChildSV%>% <= 抽水比例 <= <%=ParentSV %>%](请输入整数)</td>                
                </tr>  
				<tr>
					<td style="width: 200px; text-align: right;">
						真实姓名:</td>
				...
				<tr>
					<td colspan="2" align="center">
						<asp:Button ID="btnSave" runat="server" CssClass="put" Text=" 修 改 " OnClick="btnSave_Click" OnClientClick="return f_checkIsNull()" />
						<input id="btnBack" type="button" class="put" onclick="document.location.href='<%=Utility.Common.UrlValue %>'" value=" 返 回 " />
					</td>
				</tr>
			</table>
		</div>
...
<script type="text/javascript">
    function OnExsitDomainName(){
        ...
        var reval = '0';
        var urlData = '/Admin/XmlHttpAdmin.aspx?type=updomainexit&name='+escape(txt.value.trim())+'&id=<%=AgencyID %>';
        //alert(urlData);
        try{
