            ...
            <td style='display: none' id='submenu3022'>
                <div class="sec_menu" style='width: 158'>
                    <table width="130" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td height="20">
                                <a href="Cloth/BuyClothLog.aspx" target="main">◆&nbsp;服装购买记录</a>
                            </td>
                        </tr>
                    </table>
                </div>
...
<table style="display:none;" id="table_14" cellpadding="0" cellspacing="0" width="158" align="center">
  ...
  <tr>
                ...
                <div class="sec_menu" style='width: 158'>
                    <table cellpadding="0" cellspacing="0" align="center" width="130">
                        <tr>
                            <td height="20">
                                <br />
                                版权所有：<a href="" title="北京天瑞地安网络科技有限公司" onclick="openUrl();">北京天瑞地安网络科技有限公司</a><br />
                                <br />
                                <br />
                            </td>
                        </tr>
    ...
    <script type="text/ecmascript">
        ...
        function openUrl() {
    window.open("http://www.youxi568.com");
        }
    </script>
