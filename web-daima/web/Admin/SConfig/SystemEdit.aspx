        ...
        <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
            ...
            <tr>
                <td align="right">
                    参数值：</td>
                <td align="left">
                    <asp:TextBox ID="txtParaValue" runat="server" CssClass="put" Width="500" MaxLength="500"></asp:TextBox></td>
            </tr>
             <tr>
                <td align="right">
                    描述：</td>
                <td align="left">
                    <asp:TextBox ID="txtParaDesc" runat="server" CssClass="put" Width="500" MaxLength="500"></asp:TextBox></td>
            </tr>
           <td align="right">
              &nbsp;
            </td>
