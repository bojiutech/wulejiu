		...
		<asp:Repeater ID="PrizesHList" runat="server">
			<ItemTemplate>
				<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7" bgcolor="F2F8FF" class="admin_table">
					...
					<td align="left">&nbsp;&nbsp;<%#Eval("T_UndoMsg")%>个&nbsp;&nbsp;<a href="/admin/Books/Book.aspx">查看</a></td>
					</tr>
					<tr><td align="right" width="34%">
					未审核的照片数&nbsp;&nbsp;&nbsp;
					</td>
					<td align="left">&nbsp;&nbsp;<%#Eval("T_UndoPhoto")%>张&nbsp;&nbsp;<a href="/admin/Users/Pictures.aspx">查看</a></td>
					</tr>
					<tr><td align="right" width="34%">
					未审核的奖品兑换记录数&nbsp;&nbsp;&nbsp;
					</td>
					<td align="left">&nbsp;&nbsp;<%#Eval("T_UndoPrizeExchange")%>条&nbsp;&nbsp;<a href="/admin/Prizes/PrizesH.aspx">查看</a></td>
					</tr>
				</table>
			</ItemTemplate>
		</asp:Repeater>
