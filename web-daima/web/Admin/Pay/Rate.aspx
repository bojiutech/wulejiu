    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr style='<%=ConfigurationManager.AppSettings["IsPayToPoint"]=="1"?"":"display:none;" %>'>
         ...
         <tr>
            ...
            <td align="left">
             <asp:TextBox ID="TextDiamond" runat="server" Text="0" MaxLength="19"></asp:TextBox> 钻石
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextDiamond"
                    Display="Dynamic" ErrorMessage="请输入每1元点卡可兑换钻石数"></asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="TextDiamond"
                    Display="Dynamic" ErrorMessage="只能输入大于0的整数！" Operator="GreaterThan" Type="Integer"
                    ValueToCompare="0"></asp:CompareValidator>
            </td>
        </tr>
          <tr>
            ...
            <td align="left">
             <asp:TextBox ID="TxtDiamondToMoney" runat="server"  MaxLength="19"></asp:TextBox> 金币
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextDiamond"
                    Display="Dynamic" ErrorMessage="请输入每1个钻石可兑换金币数"></asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="TextDiamond"
                    Display="Dynamic" ErrorMessage="只能输入大于0的整数！" Operator="GreaterThan" Type="Integer"
                    ValueToCompare="0"></asp:CompareValidator>
            </td>
        </tr>
            ...
            <td align="left">
                <asp:TextBox runat="server" ID="txtRebate" MaxLength="4"  ></asp:TextBox>0.01~1.00
            </td>
        </tr>
        <tr>
            <td align="right" width="25%">
