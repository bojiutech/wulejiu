<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobilePayConfig.aspx.cs"
    Inherits="Admin_Pay_MobilePayConfig" %>
...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="A4B6D7"
        ...
        <caption>
            <font color='red'><strong>手游充值配置</strong></font></caption>
        <tr>
            <th>
                ID
            </th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                      ...
                      <td align="center">
                        <%#Convert.ToInt32( Eval("stype").ToString())==1?"金币":"钻石"%>
                    </td>
                    <td align="center">
                        <a href="MobilePayConfig.aspx?action=edit&GameType=<%=GameType %>&params=<%# Eval("ID") %>&reurl=<%=Server.UrlEncode(Request.Url.AbsoluteUri) %>">
                            修改</a>&nbsp;&nbsp; <a href="MobilePayConfig.aspx?action=del&GameType=<%=GameType %>&params=<%# Eval("ID") %>&reurl=<%=Server.UrlEncode(Request.Url.AbsoluteUri) %>"
    ...
    <table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            <th colspan="2">
                添加/修改手游支付宝充值配置&nbsp;&nbsp;&nbsp;<a href="MobilePayConfig.aspx?GameType=<%=GameType %>">添加</a>
            </th>
        </tr>
        <tr>
            <th align="right">
        ...
        <tr>
           ...
           <tr>
            ...
            <td align="left">
               <asp:DropDownList ID="DropDStype" runat="server">
