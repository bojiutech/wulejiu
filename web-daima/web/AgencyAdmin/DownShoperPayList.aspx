<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownShoperPayList.aspx.cs" Inherits="Bzw.Web.AgencyAdmin.DownShoperPayList" %>
                            ...
                            <asp:Repeater ID="rptDataList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%#Convert.ToInt32(Eval("PayType")) == 1 ? "<font color='red'>" + Eval("OperationNum").ToString() + "(点卡号)</font>" : Eval("OperationNum").ToString() + "(订单号)"%>
                                        </td>
                                        <td>
                                            <%# Eval("AgencyID")%>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <%# Convert.ToInt32(Eval("gType").ToString())==1?"网银":"点卡"%>
                                        </td>
                                        <td>
