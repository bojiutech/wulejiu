<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChildAgencyDetail.aspx.cs" Inherits="Bzw.Web.AgencyAdmin.ChildAgencyDetail" %>
		...
		<div style="text-align: center; font-size: 13px;">
			<table border="1" style="width: 98%; border-collapse: collapse;">
				...
				<tr>
					...
					<td style="text-align: left;">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:TextBox ID="txt_CS" runat="server" ReadOnly="true" BackColor="Gainsboro" />%
					</td>
				</tr>
			...
			<table border="1" style="width: 98%; border-collapse: collapse;">
				...
				<tr>
					<td colspan="2" align="center">
						<asp:Button ID="btnSave" runat="server" Text="返 回" OnClick="btnSave_Click" />
					</td>
				</tr>
			</table>
		</div>
