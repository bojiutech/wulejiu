<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankToAgency.aspx.cs" Inherits="Bzw.Web.AgencyAdmin.BankToAgency" %>
	...
	<form id="form1" runat="server">
		<div style="text-align: center; margin-top: 30px; font-size: 12px;">
			<table width="60%" style="border-collapse: collapse; text-align: center;" border="1px;">
                ...
                <tr>
					<td align="right">
						&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="该账户可提取金币数："></asp:Label></td>
				...
				<tr>
					<td colspan="2">
						<asp:Button ID="btnEnrich" runat="server" Text="提交"  OnClick="btnEnrich_Click" />
