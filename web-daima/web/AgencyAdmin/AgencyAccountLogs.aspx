<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgencyAccountLogs.aspx.cs" Inherits="Bzw.Web.AgencyAdmin.AgencyAccountLogs" %>
                            ...
                            <asp:Repeater ID="rptDataList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# Convert.ToInt32(Eval("PayType"))==0?"网银":"点卡"%>
                                        </td>
                                        <td>
