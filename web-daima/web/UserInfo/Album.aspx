                    ...
                    <div class="modipoto">
                        <asp:Repeater ID="rptAlbumColumnList" runat="server">
                            <ItemTemplate>
                                <dl>
                                    <dt>
                                        <%# "<a href='PhotoList.aspx?params=" + Eval( HN.Entities.Web_vUserAlbumColumn._.ID.Name ).ToString() + "' title='" + Eval( HN.Entities.Web_vUserAlbumColumn._.AlbumName.Name ) + "'>" + 
								...
								: "<img src='/Public/Thumbs.aspx?path="+ Server.UrlEncode(Eval(HN.Entities.Web_vUserAlbumColumn._.Cover.Name).ToString())+"&width=94&height=94' alt='" + Eval( HN.Entities.Web_vUserAlbumColumn._.AlbumName.Name ) + "' title='" + Eval( HN.Entities.Web_vUserAlbumColumn._.AlbumName.Name ) + "' />")+"</a>"%>
                                    </dt>
                                    <dd>
                                        <%#"<a href='PhotoList.aspx?params=" + Eval( HN.Entities.Web_vUserAlbumColumn._.ID.Name ).ToString() + "' title='" + Eval( HN.Entities.Web_vUserAlbumColumn._.AlbumName.Name ) + "'>" + Eval( HN.Entities.Web_vUserAlbumColumn._.AlbumName.Name ) + "</a>"%>
                                    </dd>
                                    <dd>
                                        创建时间：<%# Eval(HN.Entities.Web_vUserAlbumColumn._.InputTime.Name,"{0:yyyy-MM-dd}") %></dd>
                                    <dd>
