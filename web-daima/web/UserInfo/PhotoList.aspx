                        ...
                        <asp:Repeater ID="rptAlbumColumnList" runat="server">
                            <ItemTemplate>
                                <dl>
									...
									"<img src='/Public/Thumbs.aspx?path=" + Server.UrlEncode( Eval( HN.Entities.VUsersAlbum._.PicPath.Name ).ToString() ) + "&width=140&height=140' alt='" + Eval( HN.Entities.VUsersAlbum._.PicName.Name ) + "' title='" + Eval( HN.Entities.VUsersAlbum._.PicName.Name ) + "' onerror='this.src=\"/images/none.jpg\"' /></a>"%>
                                    </dt>
                                    <dd>
                                        <%#Eval( HN.Entities.Web_UserAlbum._.PicName.Name )%>
                                    </dd>
                                    <dd>
