<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClothList.aspx.cs" Inherits="Bzw.Web.ClothList" %>
        ...
        <div class="totalContent">
            <div class="totalHd png" style="background-image: none; background-color: #bedff6;
                ...
                <div class="text" style=" text-align:left;">
                  <a href="/daoju.aspx" style="  font-size:14px;font-weight:500">道具商城</a> &nbsp;|&nbsp; <a style=" font-size:14px;" href="/Manage/Finerylist.aspx">精品ID</a>   
          &nbsp;|&nbsp; <a style=" font-size:14px;color:#000;" href="/ClothList.aspx">服装商城</a>   
                 ...
                 <div id="prize">
                    ...
                    <asp:Repeater ID="rpCloth" runat="server">
                        ...
                        <ItemTemplate>
                            ...
                            <li title="点击购买" title='<%# Eval("LogName") %>'>
                            	<a href="/ClothDetail.aspx?id=<%#Eval("ID") %>&token=<%=Utility.Common.GetStringOfUrl("type") %>" title="点击购买">
                                      	...
                                      	<p  class="ac t03"><a href="/ClothDetail.aspx?id=<%#Eval("id") %>" title="<%# Eval("LogName") %>"><%# Eval("LogName")%></a></p>
