...
LOCAL_SRC_FILES := ../HNLobby/FontConfig.cpp \
				   ...
				   ../HNLobby/UMengShare.cpp \
				   ../HNLobby/HNReconnectionLogic.cpp \
				   ...
				   ../HNLobby/ChildLayer/ExchangeDiamonds.cpp \
				   ../HNLobby/ChildLayer/GameUserHead.cpp \
				   ../HNLobby/Popularise/SpreadEditLayer.cpp \
				   ../HNLobby/ChildLayer/GameOrderList.cpp \
				   ../HNLobby/GameVoice/GameChatLayer.cpp \
				   ../HNLobby/Reconnection/Reconnection.cpp \
				   ../HNLobby/GameVoice/GameVoiceManager.cpp \
				   ../HNLobby/CreateRoom/CreateRoomLayer.cpp \
				   ../HNLobby/CreateRoom/SelectRoomLayer.cpp \
				   ../HNLobby/CreateRoom/JoinRoomLayer.cpp \
				   ../HNLobby/CreateRoom/GameDismissDesk.cpp \
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../Classes/Reconnection \
