...
namespace HN
{
	...
	public:
		...
		// 房间登录
		void login(UINT uGameID, bool forced = false);
		...
		// 网络连接
		virtual void onConnected(bool connect) override;
	...
	protected:
		...
		// 用户快速坐下（座位平台决定）
		void H_R_M_UserFastSit(const NetMessageHead* messageHead, void* object, INT objectSize);

		// 房间消息
		void H_R_M_Room(const NetMessageHead* messageHead, void* object, INT objectSize);

		// VIP房间消息
		void H_R_M_VIP_Room(const NetMessageHead* messageHead, void* object, INT objectSize);
		...
		void H_R_M_GameBaseInfo(const NetMessageHead* messageHead, void* object, INT objectSize);
		void H_R_M_UserInfo(const NetMessageHead* messageHead, void* object, INT objectSize);
		void H_R_M_UserStats(const NetMessageHead* messageHead, void* object, INT objectSize);
		void H_R_M_Control(const NetMessageHead* messageHead, void* object, INT objectSize);
#endif
