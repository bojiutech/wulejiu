...
- (void)pay:(NSString *) orderID Price:(double)price CallBackFunc: (CALLBACK_PRAGMA*) _callbackFunc{
    ...
    ors.merchant = @"2030011640";
    ors.notify_url = @"http://www.kh178.com/manage/pay/Zhifu/MobileReceive.aspx";

    NSDateFormatter* fmt =  [[NSDateFormatter alloc]init];
    [fmt setDateFormat:@"yyyy-MM-dd HH:mm:ss"];
    ors.order_time = [fmt stringFromDate:[NSDate date]];
    
    ors.order_no = orderID;
    ...
    //用于MD5签名的key
    NSString* key = @"1234567890qwertyuiop";
